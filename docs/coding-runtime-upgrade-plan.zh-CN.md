# Coding Runtime Upgrade Plan（归档入口）
...
- 历史升级方案全文：[archive/coding-runtime-upgrade-plan.zh-CN.md](archive/coding-runtime-upgrade-plan.zh-CN.md)

历史文档中的“建议”“首批”“后续”等措辞描述的是当时的设计阶段，不能用来判断当前代码是否缺少功能。
