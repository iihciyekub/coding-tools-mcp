# Coding Tools MCP Boundary Findings (Historical Archive)

Archive status: this document records a historical dogfood snapshot. Several
items below were subsequently fixed and covered by regression tests; this file
is retained as implementation history rather than a current issue tracker. See
`../limitations.md`, `../security-boundary.md`, and `../runtime-contract-v0.3.md`
