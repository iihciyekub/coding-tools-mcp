# Coding Tools MCP 开发能力升级方案（历史归档）

归档状态：本文保留 2026-09-11 前后的升级设计、取舍和里程碑记录，用于追溯实现来源，不再作为当前能力清单或待办列表。M1–M3 的主要闭环已经进入正式实现；当前事实请以 `../runtime-contract-v0.3.md`、`../tools-and-schemas.md`、`../../SPEC.md` 与 `../../apps/desktop-client/README.md` 为准。文中仍使用“建议”“后续”“首批”等措辞的段落代表当时的设计阶段，不应据此判断当前代码缺失功能。
