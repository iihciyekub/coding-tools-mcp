...
def assert_sdk_smoke(test: unittest.TestCase, summary: dict[str, Any]) -> None:
    ...
    test.assertIn("Relative paths stay project-relative", summary["instructions"], summary)
    test.assertIn("anchored to the bound project root", summary["instructions"], summary)
