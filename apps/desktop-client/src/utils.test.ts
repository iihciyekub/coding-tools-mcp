...
const profile: WorkspaceProfile = {
  ...
  runtime: { computer_enabled: false, server_name_prefix: "www", local_port: 28767, permission_mode: "trusted", file_access_scope: "workspace", allowed_paths: [], environment_variables: [] },
};
